...
public class DragonFireEnchant implements CustomEnchant {

    private static final String RAW_LORE  = "&7Dragon Fire Particles";

    @Override public String getIdentifier() { return "dragon_fire_particles"; }
