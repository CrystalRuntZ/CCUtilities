...
public class WingBurstEnchant implements CustomEnchant {

    private static final String RAW_LORE  = "&7Wing Burst Particles";

    @Override public String getIdentifier() { return "wing_burst_particles"; }
