...
public class AutumnParticlesEnchant implements CustomEnchant {

    private static final String RAW_LORE = "&7Autumn Particles";

    @Override public String getIdentifier() { return "autumn_particles"; }
    @Override public String getLoreLine()   { return RAW_LORE; }

    @Override
    public boolean appliesTo(ItemStack item) {
        return item != null && item.getType() != Material.AIR; // anything is allowed
    }
    ...
    // Central CustomParticlesListener handles equip/unequip visibility
