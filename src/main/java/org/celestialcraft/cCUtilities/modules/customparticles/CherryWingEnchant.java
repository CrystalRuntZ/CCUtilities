...
public class CherryWingEnchant implements CustomEnchant {

    private static final String RAW_LORE = "&7Cherry Wing Particles";

    @Override public String getIdentifier() { return "cherry_wing_particles"; }
