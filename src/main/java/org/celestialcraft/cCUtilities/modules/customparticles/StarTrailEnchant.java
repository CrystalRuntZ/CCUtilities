...
public class StarTrailEnchant implements CustomEnchant {

    private static final String RAW_LORE  = "&7Star Trail Particles";

    @Override public String getIdentifier() { return "star_trail_particles"; }
