...
public class LightningArcEnchant implements CustomEnchant {

    private static final String RAW_LORE  = "&7Lightning Arc Particles";

    @Override public String getIdentifier() { return "lightning_arc_particles"; }
