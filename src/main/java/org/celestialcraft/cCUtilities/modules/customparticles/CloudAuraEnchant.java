...
public class CloudAuraEnchant implements CustomEnchant {

    private static final String RAW_LORE  = "&7Cloud Aura Particles";

    @Override public String getIdentifier() { return "cloud_aura_particles"; }
