...
public class WaterSplashEnchant implements CustomEnchant {

    private static final String RAW_LORE  = "&7Water Splash Particles";

    @Override public String getIdentifier() { return "water_splash_particles"; }
